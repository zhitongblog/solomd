...
async function refreshRoot() {
  ...
  // Vue picks up the change. (Re-assigning the same raw object back into
  // root.value after mutating it externally is a no-op — ref's setter
  // checks identity. Going through `root.value.x = y` routes through
  // the reactive proxy and does trigger updates. This was the v2.3.0
  // bug: "Loading…" never went away because the second `root.value =`
  // saw the same reference and skipped the update.)
