...
Latest release: [v3.5.5](https://github.com/zhitongblog/solomd/releases/latest).
...
```
https://github.com/zhitongblog/solomd/releases/latest/download/SoloMD_3.5.5_universal.dmg
```
...
- [`SoloMD_3.5.5_x64_en-US.msi`](https://github.com/zhitongblog/solomd/releases/latest/download/SoloMD_3.5.5_x64_en-US.msi)
- [`SoloMD_3.5.5_x64-setup.exe`](https://github.com/zhitongblog/solomd/releases/latest/download/SoloMD_3.5.5_x64-setup.exe) (NSIS)
- [`SoloMD_3.5.5_x64-portable.zip`](https://github.com/zhitongblog/solomd/releases/latest/download/SoloMD_3.5.5_x64-portable.zip) — no installer
