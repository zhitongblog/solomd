...
export const t = {
  en: {
    ...
    hero: {
      ...
      title2: 'Just write.',
      subtagline: 'v3.0 ships sync · E2EE · cloud-folder · web reader · semantic search · 14 AI providers · MCP server',
      ...
      chips: ['☁️ GitHub-backed sync', '🔒 End-to-end encrypted', '🔍 Semantic search', '📜 AutoGit history', '🔌 MCP server', '🌏 中文 first-class'],
  ...
  zh: {
    ...
    hero: {
      ...
      title1: '一个文件,一个窗口,',
      title2: '专心写作。',
      subtagline: 'v3.0 同步 · 端到端加密 · 云盘联动 · 网页只读分享 · 语义搜索 · 14 个 AI 服务 · MCP 服务',
      ...
      chips: ['☁️ GitHub 同步', '🔒 端到端加密', '🔍 语义搜索', '📜 AutoGit 历史', '🔌 MCP 服务', '🌏 中文一等公民'],
