...
export const t = {
  en: {
    ...
    hero: {
      badge: 'v1.3.1 · MIT · Cross-platform',
    ...
    features: {
      ...
      items: [
        { icon: '🎤', title: 'Slideshow mode (NEW)', desc: 'Press ⌘⌥P to render the active doc as fullscreen slides, split on `---`. Vim-style nav, code highlighting, KaTeX, Mermaid all work in slides.' },
        { icon: '💻', title: 'CLI tool (NEW)', desc: '`solomd open / new / list / search / cat` — open and grep notes from the terminal. Curl one-liner installer.' },
        { icon: '🪄', title: 'Format Markdown (NEW)', desc: '⌘⌥L runs Prettier — normalizes lists, tables, spacing. Front matter preserved.' },
        { icon: '👋', title: 'Welcome Tour (NEW)', desc: 'First launch opens 4 in-memory tutorial tabs in your language (en / 中文). Reopen anytime via the command palette.' },
    ...
    compare: {
      ...
      rows: [
        ...
        ['CLI tool', '✅ (solomd)', '❌', '❌', '❌'],
        ['Format Markdown (Prettier)', '✅', '❌', '❌', '🟡 (plugin)'],
        ['Clean AI artifacts', '✅', '❌', '❌', '❌'],
        ['Custom CSS', '✅', '✅', '✅', '✅'],
        ['Native menu bar', '✅', '✅', '✅', '✅'],
        ['Auto-update check', '✅', '✅', '❌', '✅'],
  ...
  zh: {
    ...
    features: {
      ...
      items: [
        { icon: '🎤', title: '演讲模式（NEW）', desc: '⌘⌥P 把当前文档变成全屏幻灯片，按 `---` 分页。代码高亮、数学公式、Mermaid 图表全部能在幻灯片里渲染。' },
        { icon: '💻', title: 'CLI 工具（NEW）', desc: '`solomd open / new / list / search / cat` —— 终端开/建/搜笔记。一行 curl 安装。' },
        { icon: '🪄', title: 'Markdown 格式化（NEW）', desc: '⌘⌥L 调用 Prettier，规范列表/表格/空格，front matter 完整保留。' },
        { icon: '👋', title: '欢迎教程（NEW）', desc: '首次启动按系统语言打开 4 个教程标签页（中 / 英）。命令面板里随时可重开。' },
